...
void main(List<String> args) {
  ...
  if (config.mode == _GeneratorMode.scan ||
    ...
    final scanSolver = _FourSuitSeedSolver(
  ...
  static _GeneratorConfig fromArgs(List<String> args) {
    ...
    return _GeneratorConfig(
      ...
      candidateFilePath: stringArg(
        'candidate-file',
        'tool/tmp_candidate_seeds_4suit.txt',
      ),
...
Options:
  ...
  --candidate-file=<path>        Candidate CSV path (default: tool/tmp_candidate_seeds_4suit.txt)
